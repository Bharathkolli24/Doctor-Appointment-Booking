...
const userModel = mongoose.models.user || mongoose.model('user',userSchema)   // if models.doctor model is available we will use that model if not available we will use doctorSchema
