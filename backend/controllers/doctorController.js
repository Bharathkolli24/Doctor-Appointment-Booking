...
const updateDoctorProfile = async (req,res)=> {
    try {
        ...
        await doctorModel.findByIdAndUpdate(docId,{fees,address,available})   // By executing this it will update doctor data with latest fee and address and available 
